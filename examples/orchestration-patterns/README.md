# OAAS Orchestration Patterns - Working Examples

This directory contains working implementations of various orchestration patterns using the OpenAPI AI Agents Standard (OAAS). These examples demonstrate how to coordinate multiple AI agents to solve complex problems efficiently.
