...
For complete integration analysis, see: [agent-buildkit AIFlow Integration Guide](https://gitlab.bluefly.io/llm/agent-buildkit/wiki/AIFlow-Integration-with-OSSA-BuildKit-and-K-Agent)
