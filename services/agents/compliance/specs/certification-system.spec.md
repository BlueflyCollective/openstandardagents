...
# Feature: Certification System

## User Story
As a developer using the OpenAPI AI Agents Standard
I want certification system
...
When I invoke the certification-system endpoint
Then I should receive a valid response
And the response should conform to the OpenAPI spec

### Scenario 2: Error handling
Given the agent is operational
When I send invalid data to certification-system
...
When multiple requests are sent to certification-system
