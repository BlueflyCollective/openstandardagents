...
When I invoke the caching-strategies endpoint
Then I should receive a valid response
And the response should conform to the OpenAPI spec

### Scenario 2: Error handling
Given the agent is operational
When I send invalid data to caching-strategies
...
When multiple requests are sent to caching-strategies
