...
I want partnership development
...
When I invoke the partnership-development endpoint
Then I should receive a valid response
And the response should conform to the OpenAPI spec

### Scenario 2: Error handling
Given the agent is operational
When I send invalid data to partnership-development
...
When multiple requests are sent to partnership-development
