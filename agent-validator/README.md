...
OSSA v0.1.8 advanced tier agent for validation operations with UADP discovery protocol support.
...
ossa discovery find --capabilities validation_analysis
...
- **CrewAI**: validation specialist role
