...
OSSA v0.1.8 advanced tier agent for quality operations with UADP discovery protocol support.
...
ossa discovery find --capabilities quality_analysis
...
- **CrewAI**: quality specialist role
