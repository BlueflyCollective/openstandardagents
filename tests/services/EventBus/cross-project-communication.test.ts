...
describe('CrossProjectCommunication', () => {
  ...
  describe('Message Sending', () => {
    ...
    test('should reject message with unauthorized target', async () => {
      ...
      await expect(
        ...
        'Communication not allowed from unauthorized-project to target-project'
      );
    });
    ...
    test('should reject message with unauthorized event type', async () => {
      await expect(
        ...
        'Event type unauthorized.event not allowed for project source-project'
      );
    });
  ...
  describe('Statistics and Monitoring', () => {
    ...
    test('should return available contracts for project', async () => {
      ...
      const availableContracts =
        crossProjectComm.getAvailableContracts('target-project');
  ...
  describe('Project Validation', () => {
    ...
    test('should validate project setup', async () => {
      const validation =
        await crossProjectComm.validateProjectSetup('validation-project');
    ...
    test('should return errors for unregistered project', async () => {
      const validation = await crossProjectComm.validateProjectSetup(
        'nonexistent-project'
      );
      ...
      expect(validation).toMatchObject({
        ...
        errors: expect.arrayContaining([
          expect.stringContaining(
            'Project nonexistent-project is not registered'
          ),
        ]),
      });
    });
    ...
    test('should provide recommendations for incomplete setup', async () => {
      ...
      const validation =
        await crossProjectComm.validateProjectSetup('incomplete-project');
  ...
  describe('Error Scenarios', () => {
    ...
    test('should handle contract registration errors', async () => {
      mockEventBus.registerContract.mockRejectedValueOnce(
        new Error('Contract registration failed')
      );
