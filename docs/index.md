...
Welcome to the OSSA documentation. This comprehensive guide covers all aspects of the OSSA specification, from getting started to advanced implementation details.
...
### 🔌 API Reference
- [API Documentation](api-reference/) - Complete API specifications
- [Schema Examples](api-reference/schema-examples.md) - Sample schemas and payloads
...
- [OSSA Specification](https://gitlab.bluefly.io/llm/openapi-ai-agents-standard)
- [GitLab Repository](https://gitlab.bluefly.io/llm/openapi-ai-agents-standard)
- [API Documentation](https://llm.bluefly.io/ossa)
