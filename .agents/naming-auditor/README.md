...
OSSA v0.1.8 advanced tier agent for compliance operations with UADP discovery protocol support.
...
ossa discovery find --capabilities compliance_analysis
...
- **CrewAI**: compliance specialist role
